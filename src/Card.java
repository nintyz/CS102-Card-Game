...
public class Card implements Comparable<Card> {
   ...
   /**
    * Generates the filename associated with the card. <code>getFilename</code>
    ...
    * the rank value of the card and <b>S</b> is a single character used to
    * represent
    * the suit value of the card.
    * <p>
    * The characters used for <b>R</b> are:
    * 'a' (ace), '2', '3', '4', '5', '6', '7', '8', '9',
    * 't' (10), 'j' (jack), 'q' (queen), and 'k' (king).
    * <p>
    * The characters used for <b>S</b> are:
    * 'c' (clubs), 'd' (diamonds), 'h' (hearts), and 's' (spades).
    * <p>
    * Two other cards are also available: "b.gif" (back of card) and "j.gif"
    * (joker).
    *
